...
CHomework5Doc::CHomework5Doc() noexcept
{
...
void CHomework5Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CHomework5Doc::InitializeSearchContent()
{
...
void CHomework5Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
